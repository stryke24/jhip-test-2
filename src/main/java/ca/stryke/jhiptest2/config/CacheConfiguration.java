...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ca.stryke.jhiptest2.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ca.stryke.jhiptest2.repository.UserRepository.USERS_BY_EMAIL_CACHE);
