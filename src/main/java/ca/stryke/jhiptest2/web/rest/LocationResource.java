...
import ca.stryke.jhiptest2.domain.Location;
import ca.stryke.jhiptest2.service.LocationService;
...
/**
 * REST controller for managing {@link ca.stryke.jhiptest2.domain.Location}.
 */
@RestController
@RequestMapping("/api")
public class LocationResource {
    ...
    public ResponseEntity<Location> partialUpdateLocation(@RequestBody Location location) throws URISyntaxException {
        log.debug("REST request to update Location partially : {}", location);
        if (location.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
