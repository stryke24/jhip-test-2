...
import ca.stryke.jhiptest2.domain.Employee;
import ca.stryke.jhiptest2.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link ca.stryke.jhiptest2.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeResource {
    ...
    public ResponseEntity<Employee> partialUpdateEmployee(@RequestBody Employee employee) throws URISyntaxException {
        log.debug("REST request to update Employee partially : {}", employee);
        if (employee.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
