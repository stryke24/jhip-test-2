...
import ca.stryke.jhiptest2.domain.Department;
import ca.stryke.jhiptest2.service.DepartmentService;
...
/**
 * REST controller for managing {@link ca.stryke.jhiptest2.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    public ResponseEntity<Department> partialUpdateDepartment(@NotNull @RequestBody Department department) throws URISyntaxException {
        log.debug("REST request to update Department partially : {}", department);
        if (department.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
