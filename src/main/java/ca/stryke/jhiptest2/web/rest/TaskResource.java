...
import ca.stryke.jhiptest2.domain.Task;
import ca.stryke.jhiptest2.service.TaskService;
...
/**
 * REST controller for managing {@link ca.stryke.jhiptest2.domain.Task}.
 */
@RestController
@RequestMapping("/api")
public class TaskResource {
    ...
    public ResponseEntity<Task> partialUpdateTask(@RequestBody Task task) throws URISyntaxException {
