...
import ca.stryke.jhiptest2.domain.Country;
import ca.stryke.jhiptest2.service.CountryService;
...
/**
 * REST controller for managing {@link ca.stryke.jhiptest2.domain.Country}.
 */
@RestController
@RequestMapping("/api")
public class CountryResource {
    ...
    public ResponseEntity<Country> partialUpdateCountry(@RequestBody Country country) throws URISyntaxException {
        log.debug("REST request to update Country partially : {}", country);
        if (country.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
