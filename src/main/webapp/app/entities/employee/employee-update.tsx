          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : employeeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="employee-manager" data-cy="manager" type="select" className="form-control" name="manager.id">
                  <option value="" key="0" />
                  {employees
              ...
              <AvGroup>
                ...
                <AvInput id="employee-department" data-cy="department" type="select" className="form-control" name="department.id">
                  <option value="" key="0" />
                  {departments
