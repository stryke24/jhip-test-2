          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="FRENCH">{translate('jhipTest2App.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('jhipTest2App.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('jhipTest2App.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                ...
                <AvInput id="job-history-job" data-cy="job" type="select" className="form-control" name="job.id">
                  <option value="" key="0" />
                  {jobs
              ...
              <AvGroup>
                ...
                <AvInput id="job-history-department" data-cy="department" type="select" className="form-control" name="department.id">
                  <option value="" key="0" />
                  {departments
              ...
              <AvGroup>
                ...
                <AvInput id="job-history-employee" data-cy="employee" type="select" className="form-control" name="employee.id">
                  <option value="" key="0" />
                  {employees
